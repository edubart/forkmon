...
/* Compile hash: bPUqwhCn4jrFbXfbEb5SoFvmmVY */
/* ------------------------------ DECLARATIONS ------------------------------ */
#ifdef __GNUC__
...
void _nelua_assert_line22(bool cond, nlstring msg) {
  if(nelua_unlikely(!cond)) {
    fwrite("forkmonhook.nelua:38:10: runtime error: ", 1, 40, stderr);
    fwrite(msg.data, msg.size, 1, stderr);
...
void _nelua_assert_line23(bool cond, nlstring msg) {
  if(nelua_unlikely(!cond)) {
    fwrite("forkmonhook.nelua:40:10: runtime error: ", 1, 40, stderr);
    fwrite(msg.data, msg.size, 1, stderr);
...
void _nelua_assert_line24(bool cond, nlstring msg) {
  if(nelua_unlikely(!cond)) {
    fwrite("forkmonhook.nelua:59:12: runtime error: ", 1, 40, stderr);
    fwrite(msg.data, msg.size, 1, stderr);
...
void _nelua_assert_line25(bool cond, nlstring msg) {
  if(nelua_unlikely(!cond)) {
    fwrite("forkmonhook.nelua:66:10: runtime error: ", 1, 40, stderr);
    fwrite(msg.data, msg.size, 1, stderr);
...
void _nelua_assert_line26(bool cond, nlstring msg) {
  if(nelua_unlikely(!cond)) {
    fwrite("forkmonhook.nelua:110:14: runtime error: ", 1, 41, stderr);
    fwrite(msg.data, msg.size, 1, stderr);
    fwrite("\n      assert(pid >= 0, '[forkmon] fork failed')\n             ^~~~~~~~\n", 1, 71, stderr);
    nelua_abort();
  }
...
void _nelua_assert_line27(bool cond, nlstring msg) {
  if(nelua_unlikely(!cond)) {
    fwrite("forkmonhook.nelua:155:10: runtime error: ", 1, 41, stderr);
    fwrite(msg.data, msg.size, 1, stderr);
