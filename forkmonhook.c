...
/* Compile hash: 2AdNxcUncp15z9WCFqorAtPjdhUT */
/* ------------------------------ DECLARATIONS ------------------------------ */
#ifdef __GNUC__
...
typedef nlmulret_nlboolean_nlint64_nlstring (*function_4R433ir11uxhTCQKF)(nelua_sequence_string, int64_t);
typedef struct nlmulret_function_4R433ir11uxhTCQKF_nelua_sequence_string_nlint64 {
  function_4R433ir11uxhTCQKF r1;
  nelua_sequence_string r2;
  int64_t r3;
} nlmulret_function_4R433ir11uxhTCQKF_nelua_sequence_string_nlint64;
static nelua_inline nlmulret_nlboolean_nlint64_nlstring nelua_ipairs_next(nelua_sequence_string a_1, int64_t k);
static nelua_inline nlmulret_function_4R433ir11uxhTCQKF_nelua_sequence_string_nlint64 nelua_ipairs_1(nelua_sequence_string a);
...
typedef int (*function_2fD8L4MtUJQ6XbS38)(FILE_ptr);
struct nelua_FStream {
  FILE_ptr fp;
  function_2fD8L4MtUJQ6XbS38 closef;
};
...
typedef nlmulret_nlboolean_nlstring_nelua_span_string (*function_4ftNez5i7UqSuaRts)(nelua_GMatchState_ptr, nlstring);
typedef struct nlmulret_function_4ftNez5i7UqSuaRts_nelua_GMatchState_nlstring {
  function_4ftNez5i7UqSuaRts r1;
  nelua_GMatchState r2;
  nlstring r3;
} nlmulret_function_4ftNez5i7UqSuaRts_nelua_GMatchState_nlstring;
...
static nlmulret_function_4ftNez5i7UqSuaRts_nelua_GMatchState_nlstring nelua_nlstring_gmatchview_1(nlstring s, nlstring pattern, nlniltype init);
...
typedef int (*function_2eiSsytffYihmvjpr)(FILE_ptr);
static nelua_filestream nelua_filestream__from_fp(FILE_ptr fp, function_2eiSsytffYihmvjpr closef);
...
typedef void (*function_kFZ2kv7NswG2LJsL)(int);
#ifdef _WIN32
...
nlmulret_function_4R433ir11uxhTCQKF_nelua_sequence_string_nlint64 nelua_ipairs_1(nelua_sequence_string a) {
  return (nlmulret_function_4R433ir11uxhTCQKF_nelua_sequence_string_nlint64){nelua_ipairs_next, a, 0};
}
...
nlmulret_function_4ftNez5i7UqSuaRts_nelua_GMatchState_nlstring nelua_nlstring_gmatchview_1(nlstring s, nlstring pattern, nlniltype init) {
  intptr_t init_2 = 1;
  nelua_GMatchState state = (nelua_GMatchState){.ms = nelua_PatternMatcher_create(s, pattern), .init = init_2};
  return (nlmulret_function_4ftNez5i7UqSuaRts_nelua_GMatchState_nlstring){nelua_gmatch_next, state, (nlstring){0}};
}
...
nelua_filestream nelua_filestream__from_fp(FILE_ptr fp, function_2eiSsytffYihmvjpr closef) {
...
bool forkmonhook_filter_filename(nlstring filename) {
  {
    nlmulret_function_4R433ir11uxhTCQKF_nelua_sequence_string_nlint64 _ret24 = nelua_ipairs_1(forkmonhook_filter_patts);
    function_4R433ir11uxhTCQKF __fornext = _ret24.r1;
...
void forkmonhook_parse_env() {
  ...
  {
    nlmulret_function_4ftNez5i7UqSuaRts_nelua_GMatchState_nlstring _ret31 = nelua_nlstring_gmatchview_1(nelua_cstring2string(filter_env), ((nlstring){(uint8_t*)"[^;]+", 5}), NLNIL);
    function_4ftNez5i7UqSuaRts __fornext = _ret31.r1;
...
int nelua_main(int nelua_argc, char** nelua_argv) {
  { /* require 'io' */
    ...
    nelua_io_stderr = nelua_filestream__from_fp(stderr, (function_2eiSsytffYihmvjpr)NULL);
    nelua_io_stdout = nelua_filestream__from_fp(stdout, (function_2eiSsytffYihmvjpr)NULL);
    nelua_io_stdin = nelua_filestream__from_fp(stdin, (function_2eiSsytffYihmvjpr)NULL);
  }
  forkmonhook_root_pid = getpid();
  {
    forkmonhook_assertkill((signal(12, forkmonhook_signal_handler) == (function_kFZ2kv7NswG2LJsL)0), ((nlstring){(uint8_t*)"failed to setup signal handler", 30}));
