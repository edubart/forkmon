...
/* Compile hash: 2U6BK5usp2eT36c6wBdJbzwJ9ZE2 */
/* ------------------------------ DECLARATIONS ------------------------------ */
#ifdef __GNUC__
...
typedef nlmulret_nlboolean_nlint64_nlstring (*function_zWVGrRN1rbT5cQaE)(nelua_sequence_string, int64_t);
typedef struct nlmulret_function_zWVGrRN1rbT5cQaE_nelua_sequence_string_nlint64 {
  function_zWVGrRN1rbT5cQaE r1;
  nelua_sequence_string r2;
  int64_t r3;
} nlmulret_function_zWVGrRN1rbT5cQaE_nelua_sequence_string_nlint64;
static nelua_inline nlmulret_nlboolean_nlint64_nlstring nelua_ipairs_next(nelua_sequence_string a_1, int64_t k);
static nelua_inline nlmulret_function_zWVGrRN1rbT5cQaE_nelua_sequence_string_nlint64 nelua_ipairs_1(nelua_sequence_string a);
...
typedef int (*function_4L4bHFZmvHVfYPb5h)(FILE_ptr);
struct nelua_FStream {
  FILE_ptr fp;
  function_4L4bHFZmvHVfYPb5h closef;
};
...
typedef nlmulret_nlboolean_nlstring_nelua_span_string (*function_2D7KdpAFckMoCKKwB)(nelua_GMatchState_ptr, nlstring);
typedef struct nlmulret_function_2D7KdpAFckMoCKKwB_nelua_GMatchState_nlstring {
  function_2D7KdpAFckMoCKKwB r1;
  nelua_GMatchState r2;
  nlstring r3;
} nlmulret_function_2D7KdpAFckMoCKKwB_nelua_GMatchState_nlstring;
...
static nlmulret_function_2D7KdpAFckMoCKKwB_nelua_GMatchState_nlstring nelua_nlstring_gmatchview_1(nlstring s, nlstring pattern, nlniltype init);
...
typedef int (*function_4G5xLUC9MNDGmDpQB)(FILE_ptr);
static nelua_filestream nelua_filestream__from_fp(FILE_ptr fp, function_4G5xLUC9MNDGmDpQB closef);
...
typedef void (*function_3qvURc1FCguDsFU7x)(int);
#ifdef _WIN32
...
nlmulret_function_zWVGrRN1rbT5cQaE_nelua_sequence_string_nlint64 nelua_ipairs_1(nelua_sequence_string a) {
  return (nlmulret_function_zWVGrRN1rbT5cQaE_nelua_sequence_string_nlint64){nelua_ipairs_next, a, 0};
}
...
nlmulret_function_2D7KdpAFckMoCKKwB_nelua_GMatchState_nlstring nelua_nlstring_gmatchview_1(nlstring s, nlstring pattern, nlniltype init) {
  intptr_t init_2 = 1;
  nelua_GMatchState state = (nelua_GMatchState){.ms = nelua_PatternMatcher_create(s, pattern), .init = init_2};
  return (nlmulret_function_2D7KdpAFckMoCKKwB_nelua_GMatchState_nlstring){nelua_gmatch_next, state, (nlstring){0}};
}
...
nelua_filestream nelua_filestream__from_fp(FILE_ptr fp, function_4G5xLUC9MNDGmDpQB closef) {
...
bool forkmonhook_filter_filename(nlstring filename) {
  {
    nlmulret_function_zWVGrRN1rbT5cQaE_nelua_sequence_string_nlint64 _ret24 = nelua_ipairs_1(forkmonhook_filter_patts);
    function_zWVGrRN1rbT5cQaE __fornext = _ret24.r1;
...
void forkmonhook_parse_env() {
  ...
  {
    nlmulret_function_2D7KdpAFckMoCKKwB_nelua_GMatchState_nlstring _ret31 = nelua_nlstring_gmatchview_1(nelua_cstring2string(filter_env), ((nlstring){(uint8_t*)"[^;]+", 5}), NLNIL);
    function_2D7KdpAFckMoCKKwB __fornext = _ret31.r1;
...
int nelua_main(int nelua_argc, char** nelua_argv) {
  { /* require 'io' */
    ...
    nelua_io_stderr = nelua_filestream__from_fp(stderr, (function_4G5xLUC9MNDGmDpQB)NULL);
    nelua_io_stdout = nelua_filestream__from_fp(stdout, (function_4G5xLUC9MNDGmDpQB)NULL);
    nelua_io_stdin = nelua_filestream__from_fp(stdin, (function_4G5xLUC9MNDGmDpQB)NULL);
  }
  forkmonhook_root_pid = getpid();
  {
    forkmonhook_assertkill((signal(12, forkmonhook_signal_handler) == (function_3qvURc1FCguDsFU7x)0), ((nlstring){(uint8_t*)"failed to setup signal handler", 30}));
