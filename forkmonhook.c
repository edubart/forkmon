...
/* Compile hash: sHqhsanq2os4Aq6o58n3E4QHPtJ */
/* ------------------------------ DECLARATIONS ------------------------------ */
#ifdef __GNUC__
...
typedef nlmulret_nlboolean_nlint64_nlstring (*function_Hn2hLgjicFVKD4Cf)(nelua_sequence_string, int64_t);
typedef struct nlmulret_function_Hn2hLgjicFVKD4Cf_nelua_sequence_string_nlint64 {
  function_Hn2hLgjicFVKD4Cf r1;
  nelua_sequence_string r2;
  int64_t r3;
} nlmulret_function_Hn2hLgjicFVKD4Cf_nelua_sequence_string_nlint64;
static nelua_inline nlmulret_nlboolean_nlint64_nlstring nelua_ipairs_next(nelua_sequence_string a_1, int64_t k);
static nelua_inline nlmulret_function_Hn2hLgjicFVKD4Cf_nelua_sequence_string_nlint64 nelua_ipairs_1(nelua_sequence_string a);
...
typedef int (*function_7LuF3T6LBt753XrG)(FILE_ptr);
struct nelua_FStream {
  FILE_ptr fp;
  function_7LuF3T6LBt753XrG closef;
};
...
typedef nlmulret_nlboolean_nlstring_nelua_span_string (*function_4UmSefd8JBaHHYvLM)(nelua_GMatchState_ptr, nlstring);
typedef struct nlmulret_function_4UmSefd8JBaHHYvLM_nelua_GMatchState_nlstring {
  function_4UmSefd8JBaHHYvLM r1;
  nelua_GMatchState r2;
  nlstring r3;
} nlmulret_function_4UmSefd8JBaHHYvLM_nelua_GMatchState_nlstring;
...
static nlmulret_function_4UmSefd8JBaHHYvLM_nelua_GMatchState_nlstring nelua_nlstring_gmatchview_1(nlstring s, nlstring pattern, nlniltype init);
...
typedef int (*function_3eLjgaTQ6Jw7USk7K)(FILE_ptr);
static nelua_filestream nelua_filestream__from_fp(FILE_ptr fp, function_3eLjgaTQ6Jw7USk7K closef);
...
typedef void (*function_9RMG612JKwSQECRg)(int);
#ifdef _WIN32
...
nlmulret_function_Hn2hLgjicFVKD4Cf_nelua_sequence_string_nlint64 nelua_ipairs_1(nelua_sequence_string a) {
  return (nlmulret_function_Hn2hLgjicFVKD4Cf_nelua_sequence_string_nlint64){nelua_ipairs_next, a, 0};
}
...
nlmulret_function_4UmSefd8JBaHHYvLM_nelua_GMatchState_nlstring nelua_nlstring_gmatchview_1(nlstring s, nlstring pattern, nlniltype init) {
  intptr_t init_2 = 1;
  nelua_GMatchState state = (nelua_GMatchState){.ms = nelua_PatternMatcher_create(s, pattern), .init = init_2};
  return (nlmulret_function_4UmSefd8JBaHHYvLM_nelua_GMatchState_nlstring){nelua_gmatch_next, state, (nlstring){0}};
}
...
nelua_filestream nelua_filestream__from_fp(FILE_ptr fp, function_3eLjgaTQ6Jw7USk7K closef) {
...
bool forkmonhook_filter_filename(nlstring filename) {
  {
    nlmulret_function_Hn2hLgjicFVKD4Cf_nelua_sequence_string_nlint64 _ret24 = nelua_ipairs_1(forkmonhook_filter_patts);
    function_Hn2hLgjicFVKD4Cf __fornext = _ret24.r1;
...
void forkmonhook_parse_env() {
  ...
  {
    nlmulret_function_4UmSefd8JBaHHYvLM_nelua_GMatchState_nlstring _ret31 = nelua_nlstring_gmatchview_1(nelua_cstring2string(filter_env), ((nlstring){(uint8_t*)"[^;]+", 5}), NLNIL);
    function_4UmSefd8JBaHHYvLM __fornext = _ret31.r1;
...
int nelua_main(int nelua_argc, char** nelua_argv) {
  { /* require 'io' */
    ...
    nelua_io_stderr = nelua_filestream__from_fp(stderr, (function_3eLjgaTQ6Jw7USk7K)NULL);
    nelua_io_stdout = nelua_filestream__from_fp(stdout, (function_3eLjgaTQ6Jw7USk7K)NULL);
    nelua_io_stdin = nelua_filestream__from_fp(stdin, (function_3eLjgaTQ6Jw7USk7K)NULL);
  }
  forkmonhook_root_pid = getpid();
  {
    forkmonhook_assertkill((signal(12, forkmonhook_signal_handler) == (function_9RMG612JKwSQECRg)0), ((nlstring){(uint8_t*)"failed to setup signal handler", 30}));
