...
/* Compile hash: 3iYPAumHrF3o1LGBafhFm87ek3bA */
/* ------------------------------ DIRECTIVES -------------------------------- */
#ifdef __GNUC__
...
typedef nlmulret_nlboolean_nlint64_nlstring (*function_5QYgmTF3nMw7a3yis)(nelua_sequence_string, int64_t);
typedef struct nlmulret_function_5QYgmTF3nMw7a3yis_nelua_sequence_string_nlint64 {
  function_5QYgmTF3nMw7a3yis r1;
  nelua_sequence_string r2;
  int64_t r3;
} nlmulret_function_5QYgmTF3nMw7a3yis_nelua_sequence_string_nlint64;
static nelua_inline nlmulret_nlboolean_nlint64_nlstring nelua_ipairs_next(nelua_sequence_string a_1, int64_t k);
static nelua_inline nlmulret_function_5QYgmTF3nMw7a3yis_nelua_sequence_string_nlint64 nelua_ipairs_1(nelua_sequence_string a);
...
typedef int (*function_3A3BwMSpHFzBh7z7N)(FILE_ptr);
struct nelua_FStream {
  FILE_ptr fp;
  function_3A3BwMSpHFzBh7z7N closef;
};
...
typedef nlmulret_nlboolean_nlstring_nelua_span_string (*function_3cnETZnqNeFQJugWo)(nelua_GMatchState_ptr, nlstring);
typedef struct nlmulret_function_3cnETZnqNeFQJugWo_nelua_GMatchState_nlstring {
  function_3cnETZnqNeFQJugWo r1;
  nelua_GMatchState r2;
  nlstring r3;
} nlmulret_function_3cnETZnqNeFQJugWo_nelua_GMatchState_nlstring;
...
static nlmulret_function_3cnETZnqNeFQJugWo_nelua_GMatchState_nlstring nelua_nlstring_gmatchview_1(nlstring s, nlstring pattern, nlniltype init);
...
typedef int (*function_2o2T3AgqdovQLe2X7)(FILE_ptr);
static nelua_filestream nelua_filestream__from_fp(FILE_ptr fp, function_2o2T3AgqdovQLe2X7 closef);
...
nlmulret_function_5QYgmTF3nMw7a3yis_nelua_sequence_string_nlint64 nelua_ipairs_1(nelua_sequence_string a) {
  return (nlmulret_function_5QYgmTF3nMw7a3yis_nelua_sequence_string_nlint64){nelua_ipairs_next, a, 0};
}
...
nlmulret_function_3cnETZnqNeFQJugWo_nelua_GMatchState_nlstring nelua_nlstring_gmatchview_1(nlstring s, nlstring pattern, nlniltype init) {
  intptr_t init_2 = 1;
  nelua_GMatchState state = (nelua_GMatchState){.ms = nelua_PatternMatcher_create(s, pattern), .init = init_2};
  return (nlmulret_function_3cnETZnqNeFQJugWo_nelua_GMatchState_nlstring){nelua_gmatch_next, state, (nlstring){0}};
}
...
nelua_filestream nelua_filestream__from_fp(FILE_ptr fp, function_2o2T3AgqdovQLe2X7 closef) {
...
bool forkmon_filter_filename(nlstring filename) {
  {
    nlmulret_function_5QYgmTF3nMw7a3yis_nelua_sequence_string_nlint64 _ret19 = nelua_ipairs_1(forkmon_filter_patts);
    function_5QYgmTF3nMw7a3yis __fornext = _ret19.r1;
...
void forkmon_parse_env() {
  ...
  {
    nlmulret_function_3cnETZnqNeFQJugWo_nelua_GMatchState_nlstring _ret26 = nelua_nlstring_gmatchview_1(nelua_cstring2string(filter_env), ((nlstring){(uint8_t*)"[^;]+", 5}), NLNIL);
    function_3cnETZnqNeFQJugWo __fornext = _ret26.r1;
...
int nelua_main(int nelua_argc, char** nelua_argv) {
  { /* require 'io' */
    ...
    nelua_io_stderr = nelua_filestream__from_fp(stderr, (function_2o2T3AgqdovQLe2X7)NULL);
    nelua_io_stdout = nelua_filestream__from_fp(stdout, (function_2o2T3AgqdovQLe2X7)NULL);
    nelua_io_stdin = nelua_filestream__from_fp(stdin, (function_2o2T3AgqdovQLe2X7)NULL);
  }
