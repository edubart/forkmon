...
/* Compile command: gcc "forkmon.c" -o "forkmon" -Wall -fwrapv -g -Wextra -Werror -ldl -lm */
/* Compile hash: 2YudbnSdvKrdwFuBeQDLYVVNSqzt */
/* ------------------------------ DIRECTIVES -------------------------------- */
#ifdef __GNUC__
...
typedef nlmulret_nlboolean_nlint64_nlstring (*function_2WfmeQ3TrfZySTtcX)(nelua_sequence_string, int64_t);
typedef struct nlmulret_function_2WfmeQ3TrfZySTtcX_nelua_sequence_string_nlint64 {
  function_2WfmeQ3TrfZySTtcX r1;
  nelua_sequence_string r2;
  int64_t r3;
} nlmulret_function_2WfmeQ3TrfZySTtcX_nelua_sequence_string_nlint64;
static nelua_inline nlmulret_nlboolean_nlint64_nlstring nelua_ipairs_next(nelua_sequence_string a_1, int64_t k);
static nelua_inline nlmulret_function_2WfmeQ3TrfZySTtcX_nelua_sequence_string_nlint64 nelua_ipairs_1(nelua_sequence_string a);
...
typedef int (*function_3Y5BfbxuiMArAh9ks)(FILE_ptr);
struct nelua_FStream {
  FILE_ptr fp;
  function_3Y5BfbxuiMArAh9ks closef;
};
...
typedef struct forkmon_span_usize forkmon_span_usize;
typedef forkmon_span_usize* forkmon_span_usize_ptr;
typedef uintptr_t* nlusize_arr0_ptr;
struct forkmon_span_usize {
  nlusize_arr0_ptr data;
  uintptr_t size;
};
static nelua_inline nlusize_ptr forkmon_span_usize___atindex(forkmon_span_usize_ptr self, uintptr_t i);
typedef struct forkmon_hashmap_node_nil forkmon_hashmap_node_nil;
typedef forkmon_hashmap_node_nil* forkmon_hashmap_node_nil_ptr;
struct forkmon_hashmap_node_nil {
  nlstring key;
  bool value;
  uintptr_t next;
};
typedef struct forkmon_span_hashmap_node_nil forkmon_span_hashmap_node_nil;
typedef forkmon_span_hashmap_node_nil* forkmon_span_hashmap_node_nil_ptr;
typedef forkmon_hashmap_node_nil* forkmon_hashmap_node_nil_arr0_ptr;
struct forkmon_span_hashmap_node_nil {
  forkmon_hashmap_node_nil_arr0_ptr data;
  uintptr_t size;
};
static nelua_inline forkmon_hashmap_node_nil_ptr forkmon_span_hashmap_node_nil___atindex(forkmon_span_hashmap_node_nil_ptr self, uintptr_t i);
static nelua_inline void nelua_memory_spanset_1(forkmon_span_usize dest, uintptr_t x);
...
static forkmon_span_usize nelua_GeneralAllocator_spanrealloc_2(nelua_GeneralAllocator_ptr self, forkmon_span_usize s, uintptr_t size);
...
static forkmon_span_hashmap_node_nil nelua_GeneralAllocator_spanrealloc0_5(nelua_GeneralAllocator_ptr self, forkmon_span_hashmap_node_nil s, uintptr_t size);
...
static forkmon_span_usize nelua_GeneralAllocator_spanxrealloc_2(nelua_GeneralAllocator_ptr self, forkmon_span_usize s, uintptr_t size);
...
static forkmon_span_hashmap_node_nil nelua_GeneralAllocator_spanxrealloc0_4(nelua_GeneralAllocator_ptr self, forkmon_span_hashmap_node_nil s, uintptr_t size);
...
static bool nelua_stringbuilderT_write_format_3(nelua_stringbuilderT_ptr self, nlstring fmt);
...
typedef nlmulret_nlboolean_nlstring_nelua_span_string (*function_43rpxecnkxqhCVjfb)(nelua_GMatchState_ptr, nlstring);
typedef struct nlmulret_function_43rpxecnkxqhCVjfb_nelua_GMatchState_nlstring {
  function_43rpxecnkxqhCVjfb r1;
  nelua_GMatchState r2;
  nlstring r3;
} nlmulret_function_43rpxecnkxqhCVjfb_nelua_GMatchState_nlstring;
...
static nlmulret_function_43rpxecnkxqhCVjfb_nelua_GMatchState_nlstring nelua_nlstring_gmatchview_1(nlstring s, nlstring pattern, nlniltype init);
...
typedef struct {uint8_t data[48];} nluint8_arr48;
...
static void _nelua_assert_line26(bool cond);
...
typedef struct forkmon_hashmap_stringboolean forkmon_hashmap_stringboolean;
typedef forkmon_hashmap_stringboolean* forkmon_hashmap_stringboolean_ptr;
struct forkmon_hashmap_stringboolean {
  forkmon_span_usize buckets;
  forkmon_span_hashmap_node_nil nodes;
  uintptr_t size;
  nelua_GeneralAllocator allocator;
};
static nlmulret_nlusize_nlusize_nlusize forkmon_hashmap_stringboolean__find(forkmon_hashmap_stringboolean_ptr self, nlstring key);
static nelua_noinline void forkmon_hashmap_stringboolean_rehash(forkmon_hashmap_stringboolean_ptr self, uintptr_t count);
static void forkmon_hashmap_stringboolean_reserve(forkmon_hashmap_stringboolean_ptr self, uintptr_t count);
static uintptr_t forkmon_hashmap_stringboolean__find_or_make(forkmon_hashmap_stringboolean_ptr self, nlstring key);
typedef bool* nlboolean_ptr;
static nlboolean_ptr forkmon_hashmap_stringboolean_peek(forkmon_hashmap_stringboolean_ptr self, nlstring key);
static void forkmon_hashmap_stringboolean_set(forkmon_hashmap_stringboolean_ptr self, nlstring key, bool value);
...
typedef int (*function_2VaGYAfmETPEXEXu5)(FILE_ptr);
static nelua_filestream nelua_filestream__from_fp(FILE_ptr fp, function_2VaGYAfmETPEXEXu5 closef);
...
static int forkmon_root_pid = 0;
static uint64_t forkmon_last_restart_ticks = 0U;
static nelua_sequence_string forkmon_filter_patts = {0};
static forkmon_hashmap_stringboolean forkmon_tracked_files = {0};
typedef FILE_ptr (*forkmon_FopenFunc)(char*, char*);
static forkmon_FopenFunc forkmon_orig_fopen = NULL;
static forkmon_FopenFunc forkmon_orig_fopen64 = NULL;
typedef int (*forkmon_OpenFunc)(char*, int, int);
static forkmon_OpenFunc forkmon_orig_open = NULL;
...
nlmulret_function_2WfmeQ3TrfZySTtcX_nelua_sequence_string_nlint64 nelua_ipairs_1(nelua_sequence_string a) {
  return (nlmulret_function_2WfmeQ3TrfZySTtcX_nelua_sequence_string_nlint64){nelua_ipairs_next, a, 0};
}
...
nlusize_ptr forkmon_span_usize___atindex(forkmon_span_usize_ptr self, uintptr_t i) {
  return (&(self->data)[i]);
}
forkmon_hashmap_node_nil_ptr forkmon_span_hashmap_node_nil___atindex(forkmon_span_hashmap_node_nil_ptr self, uintptr_t i) {
  return (&(self->data)[i]);
}
void nelua_memory_spanset_1(forkmon_span_usize dest, uintptr_t x) {
  for(uintptr_t i = 0U, _end = dest.size; i < _end; i = i + 1) {
    memcpy((void*)(&(*forkmon_span_usize___atindex(&dest, i))), (void*)(&x), 8U);
  }
}
...
void _nelua_assert_line3(bool cond, nlstring msg) {
  if(nelua_unlikely(!cond)) {
    fwrite("/home/bart/projects/nelua/nelua-lang/lib/patternmatcher.nelua:95:16: runtime error: ", 1, 84, stderr);
    fwrite(msg.data, msg.size, 1, stderr);
...
void _nelua_assert_line4(bool cond, nlstring msg) {
  if(nelua_unlikely(!cond)) {
    fwrite("/home/bart/projects/nelua/nelua-lang/lib/patternmatcher.nelua:102:18: runtime error: ", 1, 85, stderr);
    fwrite(msg.data, msg.size, 1, stderr);
...
void _nelua_assert_line5(bool cond, nlstring msg) {
  if(nelua_unlikely(!cond)) {
    fwrite("/home/bart/projects/nelua/nelua-lang/lib/patternmatcher.nelua:156:14: runtime error: ", 1, 85, stderr);
    fwrite(msg.data, msg.size, 1, stderr);
...
void _nelua_assert_line6(bool cond, nlstring msg) {
  if(nelua_unlikely(!cond)) {
    fwrite("/home/bart/projects/nelua/nelua-lang/lib/patternmatcher.nelua:211:24: runtime error: ", 1, 85, stderr);
    fwrite(msg.data, msg.size, 1, stderr);
...
void _nelua_assert_line7(bool cond, nlstring msg) {
  if(nelua_unlikely(!cond)) {
    fwrite("/home/bart/projects/nelua/nelua-lang/lib/patternmatcher.nelua:230:14: runtime error: ", 1, 85, stderr);
    fwrite(msg.data, msg.size, 1, stderr);
...
void _nelua_assert_line8(bool cond, nlstring msg) {
  if(nelua_unlikely(!cond)) {
    fwrite("/home/bart/projects/nelua/nelua-lang/lib/patternmatcher.nelua:241:52: runtime error: ", 1, 85, stderr);
    fwrite(msg.data, msg.size, 1, stderr);
...
void _nelua_assert_line9(bool cond, nlstring msg) {
  if(nelua_unlikely(!cond)) {
    fwrite("/home/bart/projects/nelua/nelua-lang/lib/patternmatcher.nelua:251:19: runtime error: ", 1, 85, stderr);
    fwrite(msg.data, msg.size, 1, stderr);
...
void _nelua_assert_line10(bool cond, nlstring msg) {
  if(nelua_unlikely(!cond)) {
    fwrite("/home/bart/projects/nelua/nelua-lang/lib/patternmatcher.nelua:281:35: runtime error: ", 1, 85, stderr);
    fwrite(msg.data, msg.size, 1, stderr);
...
forkmon_span_usize nelua_GeneralAllocator_spanrealloc_2(nelua_GeneralAllocator_ptr self, forkmon_span_usize s, uintptr_t size) {
...
forkmon_span_hashmap_node_nil nelua_GeneralAllocator_spanrealloc0_5(nelua_GeneralAllocator_ptr self, forkmon_span_hashmap_node_nil s, uintptr_t size) {
  forkmon_hashmap_node_nil_arr0_ptr p = ((forkmon_hashmap_node_nil_arr0_ptr)nelua_GeneralAllocator_realloc0(self, (void*)s.data, (size * 32), (s.size * 32)));
  if(nelua_unlikely(((size > 0) && (p == NULL)))) {
    return s;
  }
  s.data = p;
...
void _nelua_assert_line11(bool cond, nlstring msg) {
  if(nelua_unlikely(!cond)) {
    fwrite("/home/bart/projects/nelua/nelua-lang/lib/allocators/interface.nelua:182:14: runtime error: ", 1, 91, stderr);
    fwrite(msg.data, msg.size, 1, stderr);
...
void _nelua_assert_line12(bool cond, nlstring msg) {
  if(nelua_unlikely(!cond)) {
    fwrite("/home/bart/projects/nelua/nelua-lang/lib/allocators/interface.nelua:188:14: runtime error: ", 1, 91, stderr);
    fwrite(msg.data, msg.size, 1, stderr);
    fwrite("\n    assert(p ~= nilptr, 'out of memory')\n             ^~~~~~~~~\n", 1, 65, stderr);
    nelua_abort();
  }
...
void _nelua_assert_line13(bool cond, nlstring msg) {
  if(nelua_unlikely(!cond)) {
    fwrite("/home/bart/projects/nelua/nelua-lang/lib/allocators/interface.nelua:218:19: runtime error: ", 1, 91, stderr);
    fwrite(msg.data, msg.size, 1, stderr);
    fwrite("\n    assert(s.size == size, 'out of memory')\n                  ^~~~~~~\n", 1, 71, stderr);
    nelua_abort();
  }
}
forkmon_span_usize nelua_GeneralAllocator_spanxrealloc_2(nelua_GeneralAllocator_ptr self, forkmon_span_usize s, uintptr_t size) {
...
void _nelua_assert_line14(bool cond, nlstring msg) {
  if(nelua_unlikely(!cond)) {
    fwrite("/home/bart/projects/nelua/nelua-lang/lib/allocators/interface.nelua:224:19: runtime error: ", 1, 91, stderr);
    fwrite(msg.data, msg.size, 1, stderr);
    fwrite("\n    assert(s.size == size, 'out of memory')\n                  ^~~~~~~\n", 1, 71, stderr);
    nelua_abort();
  }
...
forkmon_span_hashmap_node_nil nelua_GeneralAllocator_spanxrealloc0_4(nelua_GeneralAllocator_ptr self, forkmon_span_hashmap_node_nil s, uintptr_t size) {
...
void _nelua_assert_line18(bool cond, nlstring msg) {
  if(nelua_unlikely(!cond)) {
    fwrite("/home/bart/projects/nelua/nelua-lang/lib/stringbuilder.nelua:26:12: runtime error: ", 1, 83, stderr);
    fwrite(msg.data, msg.size, 1, stderr);
...
void _nelua_assert_line19(bool cond, nlstring msg) {
  if(nelua_unlikely(!cond)) {
    fwrite("/home/bart/projects/nelua/nelua-lang/lib/stringbuilder.nelua:34:29: runtime error: ", 1, 83, stderr);
    fwrite(msg.data, msg.size, 1, stderr);
...
uintptr_t nelua_scanformat(nluint8_arr0_ptr strfmt, nluint8_arr32_ptr form) {
  ...
  while(((strfmt)[p] != 0) && (nelua_memory_scan((void*)((nlstring){(uint8_t*)"-+ #0", 5}).data, (strfmt)[p], 5U) != NULL)) {
    p = (p + 1);
  }
...
void _nelua_assert_line20(bool cond, nlstring msg) {
  if(nelua_unlikely(!cond)) {
    fwrite("/home/bart/projects/nelua/nelua-lang/lib/stringbuilder.nelua:197:12: runtime error: ", 1, 84, stderr);
    fwrite(msg.data, msg.size, 1, stderr);
...
void _nelua_assert_line21(bool cond, nlstring msg) {
  if(nelua_unlikely(!cond)) {
    fwrite("/home/bart/projects/nelua/nelua-lang/lib/stringbuilder.nelua:199:20: runtime error: ", 1, 84, stderr);
    fwrite(msg.data, msg.size, 1, stderr);
...
void _nelua_assert_line22(bool cond, nlstring msg) {
  if(nelua_unlikely(!cond)) {
    fwrite("/home/bart/projects/nelua/nelua-lang/lib/stringbuilder.nelua:241:21: runtime error: ", 1, 84, stderr);
    fwrite(msg.data, msg.size, 1, stderr);
...
nelua_next_3:;
        ...
        _nelua_assert_line22((nb >= 0), ((nlstring){(uint8_t*)"missing argument in format", 26}));
...
bool nelua_stringbuilderT_write_format_3(nelua_stringbuilderT_ptr self, nlstring fmt) {
  uintptr_t pos = (uintptr_t)0U;
  int32_t argi = 0;
  while(pos < fmt.size) {
    uint8_t c = (fmt.data)[pos];
    ...
    if(c != 37U) {
      ...
      if(c == 37U) {
        ...
        _nelua_assert_line23((nb >= 0), ((nlstring){(uint8_t*)"missing argument in format", 26}));
        nelua_stringbuilderT_commit(self, (uintptr_t)nb);
      }
    }
  }
...
nlmulret_nlisize_nlisize nelua_nlstring_find_1(nlstring s, nlstring pattern, nlniltype init, nlniltype plain) {
  ...
  nlmulret_nlisize_nlisize _ret2 = nelua_PatternMatcher_match(&ms, init_1, plain_1);
  intptr_t startpos = _ret2.r1;
  intptr_t endpos = _ret2.r2;
  if(endpos != -1) {
...
void _nelua_assert_line24(bool cond, nlstring msg) {
  if(nelua_unlikely(!cond)) {
    fwrite("/home/bart/projects/nelua/nelua-lang/lib/string.nelua:244:35: runtime error: ", 1, 77, stderr);
    fwrite(msg.data, msg.size, 1, stderr);
...
nlmulret_nlboolean_nlstring_nelua_span_string nelua_gmatch_next(nelua_GMatchState_ptr state, nlstring it) {
  ...
  nlmulret_nlisize_nlisize _ret3 = nelua_PatternMatcher_match(&state->ms, state->init, false);
  intptr_t s_8 = _ret3.r1;
  intptr_t e = _ret3.r2;
  if(e != -1) {
    ok = true;
    state->init = (e + 2);
    matched = (nlstring){.data = ((nluint8_arr0_ptr)(&(state->ms.source.data)[s_8])), .size = (uintptr_t)(e - s_8)};
    _nelua_assert_line24((state->ms.numcaptures <= 8), ((nlstring){(uint8_t*)"too many captures", 17}));
...
nlmulret_function_43rpxecnkxqhCVjfb_nelua_GMatchState_nlstring nelua_nlstring_gmatchview_1(nlstring s, nlstring pattern, nlniltype init) {
  intptr_t init_2 = 1;
  nelua_GMatchState state = (nelua_GMatchState){.ms = nelua_PatternMatcher_create(s, pattern), .init = init_2};
  return (nlmulret_function_43rpxecnkxqhCVjfb_nelua_GMatchState_nlstring){nelua_gmatch_next, state, (nlstring){0}};
}
...
void _nelua_assert_line25(bool cond, nlstring msg) {
  if(nelua_unlikely(!cond)) {
    fwrite("/home/bart/projects/nelua/nelua-lang/lib/string.nelua:651:22: runtime error: ", 1, 77, stderr);
    fwrite(msg.data, msg.size, 1, stderr);
...
nlstring nelua_tostring_1(uint64_t x) {
  ...
  tmpbuf.data[47] = (uint8_t)0U;
  int size = snprintf((char*)(&tmpbuf), 47U, "%" PRIu64, x);
  _nelua_assert_line25(((size >= 0) && (size < 47)), ((nlstring){(uint8_t*)"tostring format failed or truncated", 35}));
  return nelua_nlstring_copy((nlstring){((nluint8_arr0_ptr)(&tmpbuf.data[0])), (uintptr_t)size});
}
void _nelua_assert_line26(bool cond) {
  if(nelua_unlikely(!cond)) {
    fwrite("/home/bart/projects/nelua/nelua-lang/lib/string.nelua:702:21: runtime error: assertion failed!\n    assert(tocstring(&tmpbuf, #tmpbuf, x)) -- ensure it's zero terminated\n                    ^~~~~~~~~~~~~~~~~~~~~\n", 1, 211, stderr);
    nelua_abort();
  }
}
...
void _nelua_assert_line27(bool cond, nlstring msg) {
  if(nelua_unlikely(!cond)) {
    fwrite("/home/bart/projects/nelua/nelua-lang/lib/string.nelua:706:34: runtime error: ", 1, 77, stderr);
    fwrite(msg.data, msg.size, 1, stderr);
...
int64_t nelua_tointeger_1(char* x, nlniltype base) {
  ...
  _nelua_assert_line26(nelua_tocstring(((nlcchar_arr0_ptr)(&tmpbuf)), 65U, nelua_cstring2string(x)));
  errno = 0;
  long long i = strtoll((char*)(&tmpbuf), (&endptr), 10);
  uintptr_t len = ((uintptr_t)endptr - (uintptr_t)(&tmpbuf));
  _nelua_assert_line27((((len > 0) && (!nelua_lt_nlisize_nlusize((((intptr_t)strlen(x))), len))) && (errno == 0)), ((nlstring){(uint8_t*)"failed to convert string to integer", 35}));
  return (int64_t)i;
}
...
nlmulret_nlusize_nlusize_nlusize forkmon_hashmap_stringboolean__find(forkmon_hashmap_stringboolean_ptr self, nlstring key) {
  ...
  uintptr_t node_index = (*forkmon_span_usize___atindex(&self->buckets, hash_index));
  uintptr_t prev_node_index = UINTPTR_MAX;
  while(node_index != UINTPTR_MAX) {
    forkmon_hashmap_node_nil_ptr node = (&(*forkmon_span_hashmap_node_nil___atindex(&self->nodes, node_index)));
...
void forkmon_hashmap_stringboolean_rehash(forkmon_hashmap_stringboolean_ptr self, uintptr_t count) {
  ...
  for(uintptr_t i = 0U, _end = self->size; i < _end; i = i + 1) {
    (*forkmon_span_hashmap_node_nil___atindex(&self->nodes, i)).next = UINTPTR_MAX;
  }
  for(uintptr_t i = 0U, _end = self->size; i < _end; i = i + 1) {
    nlmulret_nlusize_nlusize_nlusize _ret4 = forkmon_hashmap_stringboolean__find(self, (*forkmon_span_hashmap_node_nil___atindex(&self->nodes, i)).key);
    ...
    if(prev_node_index == UINTPTR_MAX) {
      (*forkmon_span_usize___atindex(&self->buckets, hash_index)) = i;
    } else {
      (*forkmon_span_hashmap_node_nil___atindex(&self->nodes, prev_node_index)).next = i;
    }
    (*forkmon_span_hashmap_node_nil___atindex(&self->nodes, i)).next = node_index;
  }
}
void forkmon_hashmap_stringboolean_reserve(forkmon_hashmap_stringboolean_ptr self, uintptr_t count) {
  forkmon_hashmap_stringboolean_rehash(self, nelua_ceil_idiv((count * 100), 75U));
}
uintptr_t forkmon_hashmap_stringboolean__find_or_make(forkmon_hashmap_stringboolean_ptr self, nlstring key) {
  if(nelua_unlikely((self->nodes.size == 0))) {
    forkmon_hashmap_stringboolean_reserve(self, 16U);
  }
  nlmulret_nlusize_nlusize_nlusize _ret5 = forkmon_hashmap_stringboolean__find(self, key);
  ...
  if(node_index != UINTPTR_MAX) {
    ...
    (*forkmon_span_hashmap_node_nil___atindex(&self->nodes, node_index_1)) = (forkmon_hashmap_node_nil){.key = key, .next = UINTPTR_MAX};
    self->size = (self->size + 1);
    if(prev_node_index == UINTPTR_MAX) {
      (*forkmon_span_usize___atindex(&self->buckets, hash_index)) = node_index_1;
    } else {
      (*forkmon_span_hashmap_node_nil___atindex(&self->nodes, prev_node_index)).next = node_index_1;
    }
    if(nelua_unlikely((self->size >= ((75U * self->buckets.size) / 100)))) {
      forkmon_hashmap_stringboolean_reserve(self, ((self->size * 200U) / 100));
    }
    return node_index_1;
  }
}
nlboolean_ptr forkmon_hashmap_stringboolean_peek(forkmon_hashmap_stringboolean_ptr self, nlstring key) {
  uintptr_t node_index = ({
    nlmulret_nlusize_nlusize_nlusize _ret6 = forkmon_hashmap_stringboolean__find(self, key);
    _ret6.r1;
  });
  if(node_index != UINTPTR_MAX) {
    return (&(*forkmon_span_hashmap_node_nil___atindex(&self->nodes, node_index)).value);
  }
  return NULL;
}
void forkmon_hashmap_stringboolean_set(forkmon_hashmap_stringboolean_ptr self, nlstring key, bool value) {
  (*forkmon_span_hashmap_node_nil___atindex(&self->nodes, forkmon_hashmap_stringboolean__find_or_make(self, key))).value = value;
}
...
nelua_filestream nelua_filestream__from_fp(FILE_ptr fp, function_2VaGYAfmETPEXEXu5 closef) {
...
nlmulret_nlboolean_nlstring_nlint64 nelua_filestream_write_1(nelua_filestream_ptr self, nlstring __arg1) {
  ...
  return (nlmulret_nlboolean_nlstring_nlint64){true, ((nlstring){(uint8_t*)"", 0}), 0};
nelua_errout:;
  nlmulret_nlboolean_nlstring_nlint64 _ret10 = nelua_fileresult(false);
...
nlmulret_nlboolean_nlstring_nlint64 nelua_filestream_writef_1(nelua_filestream_ptr self, nlstring fmt, nlstring __arg1) {
  ...
  if(!nelua_stringbuilderT_write_format_2(&sb, fmt, __arg1)) {
    nlmulret_nlboolean_nlstring_nlint64 _ret11 = (nlmulret_nlboolean_nlstring_nlint64){false, ((nlstring){(uint8_t*)"not enough memory", 17}), 0};
    { /* defer */
  ...
  if(s.size > 0) {
    ...
    if(res != s.size) {
      nlmulret_nlboolean_nlstring_nlint64 _ret13 = nelua_fileresult(false);
      nlmulret_nlboolean_nlstring_nlint64 _ret12 = (nlmulret_nlboolean_nlstring_nlint64){_ret13.r1, _ret13.r2, _ret13.r3};
      { /* defer */
        nelua_stringbuilderT_destroy(&sb);
      }
      return _ret12;
  ...
  nlmulret_nlboolean_nlstring_nlint64 _ret14 = (nlmulret_nlboolean_nlstring_nlint64){true, ((nlstring){(uint8_t*)"", 0}), 0};
  { /* defer */
    nelua_stringbuilderT_destroy(&sb);
  }
  return _ret14;
...
nlmulret_nlboolean_nlstring_nlint64 nelua_filestream_writef_2(nelua_filestream_ptr self, nlstring fmt) {
  ...
  nelua_stringbuilderT sb = {0};
  if(!nelua_stringbuilderT_write_format_3(&sb, fmt)) {
    nlmulret_nlboolean_nlstring_nlint64 _ret15 = (nlmulret_nlboolean_nlstring_nlint64){false, ((nlstring){(uint8_t*)"not enough memory", 17}), 0};
    { /* defer */
      nelua_stringbuilderT_destroy(&sb);
    }
    return _ret15;
  ...
  if(s.size > 0) {
    size_t res = fwrite((void*)s.data, (size_t)1U, (size_t)s.size, fp);
    if(res != s.size) {
      nlmulret_nlboolean_nlstring_nlint64 _ret17 = nelua_fileresult(false);
      nlmulret_nlboolean_nlstring_nlint64 _ret16 = (nlmulret_nlboolean_nlstring_nlint64){_ret17.r1, _ret17.r2, _ret17.r3};
      { /* defer */
        nelua_stringbuilderT_destroy(&sb);
      }
      return _ret16;
  ...
  nlmulret_nlboolean_nlstring_nlint64 _ret18 = (nlmulret_nlboolean_nlstring_nlint64){true, ((nlstring){(uint8_t*)"", 0}), 0};
  { /* defer */
    nelua_stringbuilderT_destroy(&sb);
  }
  return _ret18;
...
bool forkmon_filter_filename(nlstring filename) {
  {
    nlmulret_function_2WfmeQ3TrfZySTtcX_nelua_sequence_string_nlint64 _ret19 = nelua_ipairs_1(forkmon_filter_patts);
    function_2WfmeQ3TrfZySTtcX __fornext = _ret19.r1;
    nelua_sequence_string __forstate = _ret19.r2;
    int64_t __forit = _ret19.r3;
    while(true) {
      bool __forcont;
      nlstring patt;
      nlmulret_nlboolean_nlint64_nlstring _ret20 = __fornext(__forstate, __forit);
      __forcont = _ret20.r1;
      __forit = _ret20.r2;
      patt = _ret20.r3;
      if(!__forcont) {
      ...
      {
        if(({
          nlmulret_nlisize_nlisize _ret21 = nelua_nlstring_find_1(filename, patt, NLNIL, NLNIL);
          _ret21.r1;
        }) != 0) {
          return true;
        }
...
nlmulret_nlcint_nlcint forkmon_inotify_init_watch(char* filename, int mask) {
  int fd = inotify_init();
  forkmon_assertkill((fd >= 0), ((nlstring){(uint8_t*)"failed to initialize inotify", 28}));
  int wd = inotify_add_watch(fd, filename, (uint32_t)mask);
  forkmon_assertkill((wd >= 0), ((nlstring){(uint8_t*)"failed to watch file", 20}));
...
bool forkmon_monitor_file(nlstring filename) {
  ...
  if(forkmon_parent_inotify_fd >= 0) {
    ...
    forkmon_assertkill((inotify_wd >= 0), ((nlstring){(uint8_t*)"failed to watch file", 20}));
    return false;
  }
  if(!forkmon_quiet) {
  ...
  nlmulret_nlcint_nlcint _ret22 = forkmon_inotify_init_watch(nelua_string2cstring(filename), inotify_mask);
  int inotify_fd = _ret22.r1;
  int inotify_wd = _ret22.r2;
  ...
  while(true) {
    ...
    if(len > 0) {
      ...
      if(wdchange) {
        ...
        close(inotify_fd);
        nlmulret_nlcint_nlcint _ret23 = forkmon_inotify_init_watch(nelua_string2cstring(filename), inotify_mask);
        inotify_fd = _ret23.r1;
        inotify_wd = _ret23.r2;
      }
...
bool forkmon_track_file_open(char* name) {
  ...
  if(((nelua_nlstring___eq(filename, ((nlstring){(uint8_t*)"", 0})) || (({
    nlmulret_nlisize_nlisize _ret24 = nelua_nlstring_find_1(filename, ((nlstring){(uint8_t*)"^/tmp", 5}), NLNIL, NLNIL);
    _ret24.r1;
  }) != 0)) || (!forkmon_filter_filename(filename))) || (forkmon_hashmap_stringboolean_peek(&forkmon_tracked_files, filename) != NULL)) {
    { /* defer */
      nelua_nlstring_destroy(filename);
    }
    return false;
  }
  forkmon_hashmap_stringboolean_set(&forkmon_tracked_files, nelua_nlstring_copy(filename), true);
  bool _ret25 = forkmon_monitor_file(filename);
  { /* defer */
    nelua_nlstring_destroy(filename);
  }
  return _ret25;
}
int forkmon_signal_handler(int signum) {
...
void forkmon_parse_env() {
  ...
  if(!(filter_env != NULL)) {
    forkmon_errorf_1(((nlstring){(uint8_t*)_strlit1, 101}));
  }
  {
    nlmulret_function_43rpxecnkxqhCVjfb_nelua_GMatchState_nlstring _ret26 = nelua_nlstring_gmatchview_1(nelua_cstring2string(filter_env), ((nlstring){(uint8_t*)"[^;]+", 5}), NLNIL);
    function_43rpxecnkxqhCVjfb __fornext = _ret26.r1;
    nelua_GMatchState __forstate = _ret26.r2;
    nlstring __forit = _ret26.r3;
    while(true) {
      bool __forcont;
      nlmulret_nlboolean_nlstring_nelua_span_string _ret27 = __fornext(&__forstate, __forit);
      __forcont = _ret27.r1;
      __forit = _ret27.r2;
      if(!__forcont) {
        break;
      ...
      {
        (*nelua_sequence_string___atindex(&forkmon_filter_patts, (uintptr_t)(nelua_sequence_string___len(&forkmon_filter_patts) + 1))) = patt;
      }
    }
  }
  char* restart_delay_env = getenv("FORKMON_RESTART_DELAY");
  if((restart_delay_env != NULL)) {
    forkmon_restart_delay = (uint64_t)(nelua_tointeger_1(restart_delay_env, NLNIL) * 1000);
  }
  char* ignore_delay_env = getenv("FORKMON_IGNORE_DELAY");
  if((ignore_delay_env != NULL)) {
    forkmon_ignore_delay = (uint64_t)(nelua_tointeger_1(ignore_delay_env, NLNIL) * 1000);
  }
  unsetenv("LD_PRELOAD");
}
...
int nelua_main(int nelua_argc, char** nelua_argv) {
  { /* require 'io' */
    ...
    nelua_io_stderr = nelua_filestream__from_fp(stderr, (function_2VaGYAfmETPEXEXu5)NULL);
    nelua_io_stdout = nelua_filestream__from_fp(stdout, (function_2VaGYAfmETPEXEXu5)NULL);
    nelua_io_stdin = nelua_filestream__from_fp(stdin, (function_2VaGYAfmETPEXEXu5)NULL);
  }
