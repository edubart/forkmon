...
/* Compile hash: 2Dvc8jXs2Wn7Cmi3yNrSm6qmAqJJ */
/* ------------------------------ DIRECTIVES -------------------------------- */
#ifdef __GNUC__
...
typedef int (*function_MPjWejCvKLLVGuBN)(FILE_ptr);
struct nelua_FStream {
  FILE_ptr fp;
  function_MPjWejCvKLLVGuBN closef;
};
...
typedef nlmulret_nlboolean_nlstring_nelua_span_string (*function_bmhjyL8rfaL7fzp5)(nelua_GMatchState_ptr, nlstring);
typedef struct nlmulret_function_bmhjyL8rfaL7fzp5_nelua_GMatchState_nlstring {
  function_bmhjyL8rfaL7fzp5 r1;
  nelua_GMatchState r2;
  nlstring r3;
} nlmulret_function_bmhjyL8rfaL7fzp5_nelua_GMatchState_nlstring;
...
static nlmulret_function_bmhjyL8rfaL7fzp5_nelua_GMatchState_nlstring nelua_nlstring_gmatchview_1(nlstring s, nlstring pattern, nlniltype init);
...
static void _nelua_assert_line24(bool cond);
...
typedef int (*function_qiiK9ZtZBqqCbkHE)(FILE_ptr);
static nelua_filestream nelua_filestream__from_fp(FILE_ptr fp, function_qiiK9ZtZBqqCbkHE closef);
...
typedef struct {nlstring data[32];} nlstring_arr32;
static nlstring_arr32 forkmon_filter_patts = {0};
...
static char _strlit1[85] = "failed to initialize inotify, maybe increase \"user.max_inotify_instances\" in sysctl?";
...
static char _strlit2[102] = "the environment variable FORKMON_FILTER is not set, please set one (example FORKMON_FILTER=\"%.lua$\")\n";
...
uintptr_t nelua_scanformat(nluint8_arr0_ptr strfmt, nluint8_arr32_ptr form) {
  ...
  _nelua_assert_line16((p < (((nlstring){(uint8_t*)"-+ #0", 5}).size + 1)), ((nlstring){(uint8_t*)"invalid format (repeated flags)", 31}));
  ...
  _nelua_assert_line17((isdigit((int)(strfmt)[p]) == 0), ((nlstring){(uint8_t*)"invalid format (width or precision too long)", 44}));
  ((uint8_t*)form)[0] = 37U;
...
nlmulret_nlboolean_nlstring_nelua_span_string nelua_gmatch_next(nelua_GMatchState_ptr state, nlstring it) {
  ...
  if(e != -1) {
    ...
    _nelua_assert_line22((state->ms.numcaptures <= 8), ((nlstring){(uint8_t*)"too many captures", 17}));
...
nlmulret_function_bmhjyL8rfaL7fzp5_nelua_GMatchState_nlstring nelua_nlstring_gmatchview_1(nlstring s, nlstring pattern, nlniltype init) {
  intptr_t init_2 = 1;
  nelua_GMatchState state = (nelua_GMatchState){.ms = nelua_PatternMatcher_create(s, pattern), .init = init_2};
  return (nlmulret_function_bmhjyL8rfaL7fzp5_nelua_GMatchState_nlstring){nelua_gmatch_next, state, (nlstring){0}};
}
...
nlstring nelua_tostring_1(uint64_t x) {
  ...
  _nelua_assert_line23(((size >= 0) && (size < 47)), ((nlstring){(uint8_t*)"tostring format failed or truncated", 35}));
  return nelua_nlstring_copy((nlstring){((nluint8_arr0_ptr)(&tmpbuf.data[0])), (uintptr_t)size});
}
void _nelua_assert_line24(bool cond) {
  if(nelua_unlikely(!cond)) {
...
int64_t nelua_tointeger_1(char* x, nlniltype base) {
  ...
  _nelua_assert_line24(nelua_tocstring(((nlcchar_arr0_ptr)(&tmpbuf)), 65U, nelua_cstring2string(x)));
  errno = 0;
  long long i = strtoll((char*)(&tmpbuf), (&endptr), 10);
  uintptr_t len = ((uintptr_t)endptr - (uintptr_t)(&tmpbuf));
  _nelua_assert_line25((((len > 0) && (!nelua_lt_nlisize_nlusize((((intptr_t)strlen(x))), len))) && (errno == 0)), ((nlstring){(uint8_t*)"failed to convert string to integer", 35}));
  return (int64_t)i;
}
...
nelua_filestream nelua_filestream__from_fp(FILE_ptr fp, function_qiiK9ZtZBqqCbkHE closef) {
...
bool forkmon_filter_filename(nlstring filename) {
  for(int64_t i = 0, _end = (int64_t)forkmon_filter_patts_count; i < _end; i = i + 1) {
    nlstring patt = forkmon_filter_patts.data[i];
    if(({
      nlmulret_nlisize_nlisize _ret19 = nelua_nlstring_find_1(filename, patt, NLNIL, NLNIL);
      _ret19.r1;
    }) != 0) {
      return true;
    }
...
nlmulret_nlcint_nlcint forkmon_inotify_init_watch(char* filename, int mask) {
  int fd = inotify_init();
  forkmon_assertkill((fd >= 0), ((nlstring){(uint8_t*)_strlit1, 84}));
...
bool forkmon_monitor_file(nlstring filename) {
  ...
  nlmulret_nlcint_nlcint _ret20 = forkmon_inotify_init_watch(nelua_string2cstring(filename), inotify_mask);
  int inotify_fd = _ret20.r1;
  int inotify_wd = _ret20.r2;
  ...
  while(true) {
    ...
    if(len > 0) {
      ...
      if(wdchange) {
        ...
        close(inotify_fd);
        nlmulret_nlcint_nlcint _ret21 = forkmon_inotify_init_watch(nelua_string2cstring(filename), inotify_mask);
        inotify_fd = _ret21.r1;
        inotify_wd = _ret21.r2;
      }
...
bool forkmon_track_file_open(char* name) {
  ...
  if(((nelua_nlstring___eq(filename, ((nlstring){(uint8_t*)"", 0})) || (({
    nlmulret_nlisize_nlisize _ret22 = nelua_nlstring_find_1(filename, ((nlstring){(uint8_t*)"^/tmp", 5}), NLNIL, NLNIL);
    _ret22.r1;
...
void forkmon_parse_env() {
  ...
  if(!(filter_env != NULL)) {
    forkmon_errorf_1(((nlstring){(uint8_t*)_strlit2, 101}));
  }
  {
    nlmulret_function_bmhjyL8rfaL7fzp5_nelua_GMatchState_nlstring _ret23 = nelua_nlstring_gmatchview_1(nelua_cstring2string(filter_env), ((nlstring){(uint8_t*)"[^;]+", 5}), NLNIL);
    function_bmhjyL8rfaL7fzp5 __fornext = _ret23.r1;
    nelua_GMatchState __forstate = _ret23.r2;
    nlstring __forit = _ret23.r3;
    while(true) {
      bool __forcont;
      nlmulret_nlboolean_nlstring_nelua_span_string _ret24 = __fornext(&__forstate, __forit);
      __forcont = _ret24.r1;
      __forit = _ret24.r2;
      if(!__forcont) {
        break;
      ...
      nlstring patt = __forit;
      {
        ...
        forkmon_filter_patts.data[forkmon_filter_patts_count] = patt;
...
int nelua_main(int nelua_argc, char** nelua_argv) {
  { /* require 'io' */
    ...
    nelua_io_stderr = nelua_filestream__from_fp(stderr, (function_qiiK9ZtZBqqCbkHE)NULL);
    nelua_io_stdout = nelua_filestream__from_fp(stdout, (function_qiiK9ZtZBqqCbkHE)NULL);
    nelua_io_stdin = nelua_filestream__from_fp(stdin, (function_qiiK9ZtZBqqCbkHE)NULL);
  }
