...
/* Compile command: gcc "forkmon.c" -o "forkmon" -Wall -fwrapv -g -ldl -lm */
/* Compile hash: 2xyyt4hvVdJL6zVgJYAiKQYEbCSq */
/* ------------------------------ DECLARATIONS ------------------------------ */
#ifdef __GNUC__
...
typedef nlmulret_nlboolean_nlint64_nlstring (*function_5ZxLfuyEJSvMtCGFk)(nelua_sequence_string, int64_t);
typedef struct nlmulret_function_5ZxLfuyEJSvMtCGFk_nelua_sequence_string_nlint64 {
  function_5ZxLfuyEJSvMtCGFk r1;
  nelua_sequence_string r2;
  int64_t r3;
} nlmulret_function_5ZxLfuyEJSvMtCGFk_nelua_sequence_string_nlint64;
static nelua_inline nlmulret_nlboolean_nlint64_nlstring nelua_ipairs_next(nelua_sequence_string a_1, int64_t k);
static nelua_inline nlmulret_function_5ZxLfuyEJSvMtCGFk_nelua_sequence_string_nlint64 nelua_ipairs_1(nelua_sequence_string a);
...
typedef int (*function_2UNGG6apWULHUjN3J)(FILE_ptr);
struct nelua_FStream {
  FILE_ptr fp;
  function_2UNGG6apWULHUjN3J closef;
};
...
typedef nlmulret_nlboolean_nlstring_nelua_span_string (*function_3hp3DXJh7fBAkU1Mo)(nelua_GMatchState_ptr, nlstring);
typedef struct nlmulret_function_3hp3DXJh7fBAkU1Mo_nelua_GMatchState_nlstring {
  function_3hp3DXJh7fBAkU1Mo r1;
  nelua_GMatchState r2;
  nlstring r3;
} nlmulret_function_3hp3DXJh7fBAkU1Mo_nelua_GMatchState_nlstring;
...
static nlmulret_function_3hp3DXJh7fBAkU1Mo_nelua_GMatchState_nlstring nelua_nlstring_gmatchview_1(nlstring s, nlstring pattern, nlniltype init);
...
static void _nelua_assert_line25(bool cond);
...
typedef int (*function_2imeTuFZq713SAtuU)(FILE_ptr);
static nelua_filestream nelua_filestream__from_fp(FILE_ptr fp, function_2imeTuFZq713SAtuU closef);
...
static uint64_t forkmon_restart_delay = 20000U;
...
nlmulret_function_5ZxLfuyEJSvMtCGFk_nelua_sequence_string_nlint64 nelua_ipairs_1(nelua_sequence_string a) {
  return (nlmulret_function_5ZxLfuyEJSvMtCGFk_nelua_sequence_string_nlint64){nelua_ipairs_next, a, 0};
}
...
nlmulret_function_3hp3DXJh7fBAkU1Mo_nelua_GMatchState_nlstring nelua_nlstring_gmatchview_1(nlstring s, nlstring pattern, nlniltype init) {
  intptr_t init_2 = 1;
  nelua_GMatchState state = (nelua_GMatchState){.ms = nelua_PatternMatcher_create(s, pattern), .init = init_2};
  return (nlmulret_function_3hp3DXJh7fBAkU1Mo_nelua_GMatchState_nlstring){nelua_gmatch_next, state, (nlstring){0}};
}
...
void _nelua_assert_line25(bool cond) {
  if(nelua_unlikely(!cond)) {
...
int64_t nelua_tointeger_1(char* x, nlniltype base) {
  ...
  _nelua_assert_line25(nelua_tocstring(((nlcchar_arr0_ptr)(&tmpbuf)), 65U, nelua_cstring2string(x)));
  errno = 0;
  long long i = strtoll((char*)(&tmpbuf), (&endptr), 10);
  uintptr_t len = ((uintptr_t)endptr - (uintptr_t)(&tmpbuf));
  _nelua_assert_line26((((len > 0) && (!nelua_lt_nlisize_nlusize((((intptr_t)strlen(x))), len))) && (errno == 0)), ((nlstring){(uint8_t*)"failed to convert string to integer", 35}));
  return (int64_t)i;
}
...
nelua_filestream nelua_filestream__from_fp(FILE_ptr fp, function_2imeTuFZq713SAtuU closef) {
...
bool forkmon_filter_filename(nlstring filename) {
  {
    nlmulret_function_5ZxLfuyEJSvMtCGFk_nelua_sequence_string_nlint64 _ret19 = nelua_ipairs_1(forkmon_filter_patts);
    function_5ZxLfuyEJSvMtCGFk __fornext = _ret19.r1;
...
void forkmon_parse_env() {
  ...
  {
    nlmulret_function_3hp3DXJh7fBAkU1Mo_nelua_GMatchState_nlstring _ret26 = nelua_nlstring_gmatchview_1(nelua_cstring2string(filter_env), ((nlstring){(uint8_t*)"[^;]+", 5}), NLNIL);
    function_3hp3DXJh7fBAkU1Mo __fornext = _ret26.r1;
...
int nelua_main(int nelua_argc, char** nelua_argv) {
  { /* require 'io' */
    ...
    nelua_io_stderr = nelua_filestream__from_fp(stderr, (function_2imeTuFZq713SAtuU)NULL);
    nelua_io_stdout = nelua_filestream__from_fp(stdout, (function_2imeTuFZq713SAtuU)NULL);
    nelua_io_stdin = nelua_filestream__from_fp(stdin, (function_2imeTuFZq713SAtuU)NULL);
  }
